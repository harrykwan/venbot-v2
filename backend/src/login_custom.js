...
let inputcodecallback, sendcodecallback, verifyagaincallback, wrongcodecallback, rightcodecallback;
...
async function login(args = {}) {
    let {
        inputLogin = null, inputPassword = null, inputProxy = null, verificationMode = null, silentMode = false, antiBanMode = false, showRealtimeNotifications = false, onlineMode = true
    } = args;
...
function setsendcodecallback(callback) {
    sendcodecallback = callback
}

async function sendcode(ig, mode) {
...
function setinputcodecallback(callback) {
    inputcodecallback = callback
}

async function inputcode(ig, code) {
    try {
...
function setverifyagaincallback(callback) {
    verifyagaincallback = callback

}

function setwrongcodecallback(callback) {
    wrongcodecallback = callback
}

function setrightcodecallback(callback) {
    rightcodecallback = callback
}



function verifyagain(hasCookies, silentMode, inputLogin, inputPassword, inputProxy, verificationMode) {
...
exports.login = login
exports.setinputcodecallback = setinputcodecallback
exports.setsendcodecallback = setsendcodecallback
exports.setverifyagaincallback = setverifyagaincallback
exports.inputcode = inputcode
exports.sendcode = sendcode
exports.verifyagain = verifyagain
exports.setwrongcodecallback = setwrongcodecallback
exports.setrightcodecallback = setrightcodecallback